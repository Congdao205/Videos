                    ...
                    <div class="card border rounded-4">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="mb-5">
                                ...
                                <h4 class="text-center fs-1" style="font-family: cursive;">Change Password</h4>
                            </div>
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12"> 
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="id" id="id"
                                                placeholder="" required>
                                            <label for="id" class="form-label">Current Password</label>
                                        </div>
                                    </div>
                                    <div class="col-12"> 
                                        <div class="form-floating mb-3">
                                    ...
                                    <div class="col-12"> 
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="id" id="id"
                                                placeholder="" required>
                                            <label for="id" class="form-label">Confim New Password</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
